...
{isConditionTrue_0 = (gdjs.evtsExt__ArrayTools__IndexOfStr.func(runtimeScene, runtimeScene.getScene().getVariables().get("__ArrayTools").getChild("Temp"), "" + eventsFunctionContext.getArgument("Value"), eventsFunctionContext) != -(1));
}
