...
gdjs.evtsExt__MultitouchJoystick__Angle4WayDirection.idToCallbackMap = new Map();
...
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtsExt__MultitouchJoystick__AngleTo4Way.func(runtimeScene, (Number(eventsFunctionContext.getArgument("Angle")) || 0), eventsFunctionContext) == 0;
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtsExt__MultitouchJoystick__AngleTo4Way.func(runtimeScene, (Number(eventsFunctionContext.getArgument("Angle")) || 0), eventsFunctionContext) == 1;
}
if (isConditionTrue_0) {
{eventsFunctionContext.returnValue = true;}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtsExt__MultitouchJoystick__AngleTo4Way.func(runtimeScene, (Number(eventsFunctionContext.getArgument("Angle")) || 0), eventsFunctionContext) == 2;
}
if (isConditionTrue_0) {
{eventsFunctionContext.returnValue = true;}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtsExt__MultitouchJoystick__AngleTo4Way.func(runtimeScene, (Number(eventsFunctionContext.getArgument("Angle")) || 0), eventsFunctionContext) == 3;
}
if (isConditionTrue_0) {
{eventsFunctionContext.returnValue = true;}
}
