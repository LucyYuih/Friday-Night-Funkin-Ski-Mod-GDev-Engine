...
{
{eventsFunctionContext.returnValue = gdjs.evtTools.variable.getVariableChildCount(runtimeScene.getScene().getVariables().get("__FPS").getChild("FrameTimestamps")) / (gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__FPS").getChild("TimeElapsed")) / 1000);}
}
