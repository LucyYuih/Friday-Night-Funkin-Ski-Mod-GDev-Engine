...
{isConditionTrue_0 = (gdjs.evtsExt__ArrayTools__IndexOf.func(runtimeScene, runtimeScene.getScene().getVariables().get("__ArrayTools").getChild("Temp"), (Number(eventsFunctionContext.getArgument("Value")) || 0), eventsFunctionContext) != -(1));
}
