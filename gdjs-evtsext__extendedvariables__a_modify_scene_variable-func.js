...
{
{gdjs.evtsExt__ExtendedVariables__ModifySceneVariable.func(runtimeScene, "" + eventsFunctionContext.getArgument("SceneVariableName"), (Number(eventsFunctionContext.getArgument("SceneVariableValue")) || 0), eventsFunctionContext);
}
}
