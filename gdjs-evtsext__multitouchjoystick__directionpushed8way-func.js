...
gdjs.evtsExt__MultitouchJoystick__DirectionPushed8Way.idToCallbackMap = new Map();
...
isConditionTrue_0 = gdjs.evtsExt__MultitouchJoystick__JoystickForce.func(runtimeScene, (Number(eventsFunctionContext.getArgument("ControllerIdentifier")) || 0), "" + eventsFunctionContext.getArgument("JoystickIdentifier"), eventsFunctionContext) > gdjs.evtsExt__MultitouchJoystick__DeadZone.func(runtimeScene, (Number(eventsFunctionContext.getArgument("ControllerIdentifier")) || 0), "" + eventsFunctionContext.getArgument("JoystickIdentifier"), eventsFunctionContext);
